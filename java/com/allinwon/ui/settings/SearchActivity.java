package com.allinwon.ui.settings;
...
import com.allinwon.data.AddressData;
import com.allinwon.util.AddressParsingUtil;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.ViewHolder>{
        ...
        public void setFilter(String query){
            mlist.clear();
            String url="http://api.vworld.kr/req/search?key=365EB009-29C9-38F9-AEDF-EF0B7A7E33C0&service=search&request=search&type=address&query=";
